...
const Footers = (props) => {
  const logoImage =
    props.backgroundColor === "#0D0630" ? darkimage : lightimage;
  ...
  return (
    ...
    >
     ...
     data-aos-easing="ease-in-sine">
              <a href="#">
                <img class="h-12 w-24" src={logoImage} alt="" />
              </a>

              <p class="max-w-sm mt-2 text-gray-500 dark:text-gray-400">
                Hello, I'm Ibshar AKrami, a frontend developer passionate about
                creating visually stunning and user-friendly web interfaces.
              </p>

              <div class="flex mt-6 -mx-2" data-aos="fade-up"
     data-aos-offset="100"
     data-aos-easing="ease-in-sine">
                <a
                ...
                <a
                  href="https://github.com/ibsharakrami"
                  class="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400"
                  aria-label="Github"
                >
                  <svg
     ...
     data-aos-easing="ease-in-sine">
                <h3
                  ...
                  style={{
                    ...
                    color:
                      props.backgroundColor === "#0D0630" ? "white" : "#000",
                    fontWeight: "bold",
                  }}
                >
                  INFORMATION
     ...
     data-aos-offset="100"
     data-aos-easing="ease-in-sine">
                <h3 class="text-gray-700 uppercase dark:text-white"  style={{
                    // fontFamily: "AsgardTrial",
                    color:
                      props.backgroundColor === "#0D0630" ? "white" : "#000",
                    fontWeight: "bold",
     ...
     data-aos-easing="ease-in-sine">
                <h3 class="text-gray-700 uppercase dark:text-white"  style={{
                   ...
                   {/* <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline"  style={{
                    color:
                      props.backgroundColor === "#0D0630" ? "white" : "#000",
                      fontWeight: "500",
                  }}>
        ...
        <div>
          <p class="text-center text-gray-500 dark:text-gray-400">
            © ibsharcodes - All rights reserved
          </p>
        </div>
      </div>
    </footer>
